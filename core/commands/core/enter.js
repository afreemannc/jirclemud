    ...
    if (itemIndex === false) {
      ...
      if (portal.properties.flags.includes('PORTAL') === false) {
        ...
        if (typeof Rooms.room[target_rid] === undefined) {
          ...
          Rooms.message(session, target_rid, session.character.name + ' appears from somewhere else.', true);
